...
class AshtakvargaTable {
    ...
    async GenerateTable(inputArguments) {
        ...
        //generate table from inputed data
        //get data from API
        var sarvashtakavargaUrl = `http://localhost:8000/api/Calculate/SarvashtakavargaChart/${inputArguments.TimeUrl}Ayanamsa/${inputArguments.Ayanamsa}`;
        var bhinnashtakavargaUrl = `http://localhost:8000/api/Calculate/BhinnashtakavargaChart/${inputArguments.TimeUrl}Ayanamsa/${inputArguments.Ayanamsa}`;
...
class HoroscopeChat {
    ...
    LiveServerURL = "http://localhost:8000/api/Calculate";
